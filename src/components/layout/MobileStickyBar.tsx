...
export const MobileStickyBar: React.FC<MobileStickyBarProps> = ({ onOpenQuoteModal }) => {
  ...
  return (
    <div
      className="fixed bottom-0 inset-x-0 z-40 sm:hidden bg-[#4A0E1B]/95 backdrop-blur-xl border-t border-white/20 px-3 py-2 shadow-2xl safe-area-bottom"
      role="navigation"
    ...
    >
      <div className="grid grid-cols-3 gap-2 items-center">
        ...
        <a
          ...
          className="flex flex-col items-center justify-center py-2 px-1 rounded-xl bg-[#5A1426] border border-white/20 text-[#FFF8ED] active:bg-[#6E1830] transition-colors min-h-[48px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
          aria-label={`Call ${siteConfig.brand.ownerName} at ${siteConfig.contact.phonePrimary}`}
        >
          <Phone className="w-4 h-4 mb-0.5 text-[#FFF8ED]" />
        ...
        {isWhatsAppConfigured ? (
          ...
          <div
            className="flex flex-col items-center justify-center py-2 px-1 rounded-xl bg-[#5A1426]/60 border border-white/5 text-[#F7F0E4]/30 cursor-not-allowed min-h-[48px]"
        ...
        <button
          ...
          className="flex flex-col items-center justify-center py-2 px-1 rounded-xl bg-[#6E1830] border border-white/30 text-[#FFF8ED] font-bold active:brightness-110 transition-colors min-h-[48px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white shadow-sm"
          aria-label="Request an Event Quote"
        >
          <FileText className="w-4 h-4 mb-0.5 text-[#FFF8ED]" />
